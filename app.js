...
const videoFondo = document.getElementById('video-fondo'); // Instancia del video
...
// Gestión de fondo dinámico (Imagen o Vídeo)
document.getElementById('fondo-input').addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        if (file.type.startsWith('video/')) {
            // Si es un vídeo, lo mostramos y quitamos la imagen
            document.body.style.backgroundImage = 'none';
            videoFondo.src = fileURL;
            videoFondo.style.display = 'block';
            videoFondo.play();
        } else if (file.type.startsWith('image/')) {
            // Si es una imagen, la ponemos de fondo y ocultamos el vídeo
